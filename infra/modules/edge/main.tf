...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  # SPA routing: any path the bucket does not hold is served index.html with a 200. S3 answers
  # 403 rather than 404 for a missing key when the origin may GetObject but not ListBucket, so
  # both codes are mapped.
